...
\author{UHF-Gruppe der USKA}
\date{Version 0.2, CC BY-SA 4.0} % FIXME: Check license
...
im Rahmen der Lizenz CC BY-SA 4.0 gestattet.
% FIXME: Sichertellen dass latex source verfügbar bleibt, github
