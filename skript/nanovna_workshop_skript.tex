...
Dabei folgen die Punkte (und damit Impedanzen) im Smith-Diagramm diesen Regeln:
...
sind im Einklang mit diesen Regeln, denn diese Impedanzen liegen allesamt Im Punkt ganz rechts.
...
die zweite Spur die Einfügedämpfung an, beides bei der eingestellten Frequenz von 15~MHz. Diese
...
angezeigt. Wird ein zweiter Marker aktiviert, so gilt das eben erwähnte genauso für den zweiten
