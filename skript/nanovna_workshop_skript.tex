...
\addplot[color=black] table[,x index = {0}, y index = {1}] {quarterwave.dat};
\addplot[color=black,dashed] table[,x index = {0}, y index = {2}] {quarterwave.dat};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    xlabel={Frequenz},
    ylabel={Blindwiderstand $X/\Omega$},
    ticks=none,
    ymajorticks=true,
    yminorticks=true,
    scaled ticks=false,
